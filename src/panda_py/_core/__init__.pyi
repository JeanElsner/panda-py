...
class IntegratedVelocity(TorqueController):
    ...
    def set_q_diff_upper(self, q_diff_upper: numpy.ndarray[numpy.float64, _Shape[7, 1]]) -> None: ...
    def set_q_diff_lower(self, q_diff_lower: numpy.ndarray[numpy.float64, _Shape[7, 1]]) -> None: ...
    pass
